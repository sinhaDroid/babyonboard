package com.sinha.android.app.ui.adapter;
...
import com.sinha.android.app.ui.activity.MainActivity;
import com.sinha.android.app.ui.view.LoadingFeedItemView;
...
public class FeedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void setupClickableViews(final View view, final CellFeedViewHolder cellFeedViewHolder) {
        ...
        cellFeedViewHolder.ivFeedCenter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FeedAdapter.this.onClick(cellFeedViewHolder, ACTION_LIKE_IMAGE_CLICKED);
            }
        });
        cellFeedViewHolder.btnLike.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FeedAdapter.this.onClick(cellFeedViewHolder, ACTION_LIKE_BUTTON_CLICKED);
            }
        });
    }

    private void onClick(CellFeedViewHolder cellFeedViewHolder, String actionLikeClicked) {
        ...
        notifyItemChanged(adapterPosition, actionLikeClicked);
        if (context instanceof MainActivity) {
            MainActivity activity = (MainActivity) context;
            if (feedItems.get(adapterPosition).isLiked) {
                activity.showLikedSnackbar();
            } else {
                activity.showUnLikedSnackbar();
            }
            activity.checkInternetAndSendData(feedItems.get(adapterPosition).isLiked, feedItems.get(adapterPosition).likesCount);
        }
    }
